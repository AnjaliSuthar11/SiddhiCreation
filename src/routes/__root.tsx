  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "description",
        content:
          "30+ years of customised sculptures, murals, decorative gates, CNC designs, FRP products and architectural art for residential and commercial spaces.",
      },
      { name: "author", content: "Siddhi On Creation" },
